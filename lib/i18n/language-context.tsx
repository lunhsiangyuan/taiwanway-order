...
const translations: Record<Language, Record<string, unknown>> = {
  zh: {
    ...
    success: {
      title: '訂單已送出！',
      orderNumber: '訂單編號',
      message: '我們已收到您的訂單，請於指定時間到店取餐。',
      pickupInfo: '取餐資訊',
      address: '地址：73 Wickham Ave, Middletown, NY 10940',
      backToMenu: '繼續點餐',
      backToHome: '回首頁',
    },
    groupBuy: {
    ...
    footer: {
      contact: '聯絡我們',
      phone: '(845) 344-3218',
      address: '73 Wickham Ave, Middletown, NY 10940',
      hours: '營業時間：週二至週日 11:00-20:00',
      backToMain: '← 回到台灣味主站',
    },
  },
  en: {
    ...
    success: {
      ...
      orderNumber: 'Order #',
      message: 'We received your order. Please pick up at the scheduled time.',
    ...
    footer: {
      ...
      phone: '(845) 344-3218',
      address: '73 Wickham Ave, Middletown, NY 10940',
      hours: 'Hours: Tue-Sun 11:00 AM - 8:00 PM',
